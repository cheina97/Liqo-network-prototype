...
sudo gnome-terminal --hide-menubar --geometry 960x540+0+540 --title "gateway 1" -e "sudo ip netns exec gw1 tcpdump -t -n -l -i any -e -vvv icmp"
sudo gnome-terminal --hide-menubar --geometry 960x540+960+540 --title "gateway 2" -e "sudo ip netns exec gw2 tcpdump -t -n -l -i any -e -vvv icmp"
